...
namespace multiple_NB_regression_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "multiple_NB_regression.stan");
    reader.add_event(64, 62, "end", "multiple_NB_regression.stan");
    return reader;
}

class multiple_NB_regression_model
  : public stan::model::model_base_crtp<multiple_NB_regression_model> {
private:
        int N;
        ...
        double phi_sd;
public:
    multiple_NB_regression_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "multiple_NB_regression_model_namespace::multiple_NB_regression_model";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(mu,add(add(add(alpha, multiply(beta, traps)), log_sq_foot), multiply(beta_super, live_in_super)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "multiple_NB_regression_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                local_scalar_t__ mu_rep(DUMMY_VAR__);
                (void) mu_rep;  // dummy to suppress unused var warning
                stan::math::initialize(mu_rep, DUMMY_VAR__);
                stan::math::fill(mu_rep, DUMMY_VAR__);
                stan::math::assign(mu_rep,(((alpha + (beta * get_base1(traps, n, "traps", 1))) + get_base1(log_sq_foot, n, "log_sq_foot", 1)) + (beta_super * get_base1(live_in_super, n, "live_in_super", 1))));


                current_statement_begin__ = 57;
                if (as_bool(logical_gt(mu_rep, 20))) {
                ...
                stan::model::assign(pred_complaints_rep, 
                            ...
                            neg_binomial_2_log_rng(mu_rep, phi, base_rng__), 
    ...
    std::string model_name() const {
        return "multiple_NB_regression_model";
    }
...
typedef multiple_NB_regression_model_namespace::multiple_NB_regression_model stan_model;
