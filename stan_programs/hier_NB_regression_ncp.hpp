...
namespace hier_NB_regression_ncp_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "hier_NB_regression_ncp.stan");
    reader.add_event(83, 81, "end", "hier_NB_regression_ncp.stan");
    return reader;
}

class hier_NB_regression_ncp_model
  : public stan::model::model_base_crtp<hier_NB_regression_ncp_model> {
private:
        int N;
        ...
        double zeta_sd;
public:
    hier_NB_regression_ncp_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "hier_NB_regression_ncp_model_namespace::hier_NB_regression_ncp_model";
        ...
        try {
            ...
            validate_non_negative_index("Z", "J", J);
            num_params_r__ += J;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("Z", "J", J);
        context__.validate_dims("parameter initialization", "Z", "vector_d", context__.to_vec(J));
        Eigen::Matrix<double, Eigen::Dynamic, 1> Z(J);
        size_t Z_j_1_max__ = J;
        ...
        pos__ = 0U;
        validate_non_negative_index("zeta", "K", K);
        context__.validate_dims("parameter initialization", "zeta", "vector_d", context__.to_vec(K));
        Eigen::Matrix<double, Eigen::Dynamic, 1> zeta(K);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                Z = in__.vector_constrain(J, lp__);
            else
                Z = in__.vector_constrain(J);

            current_statement_begin__ = 33;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> zeta;
            (void) zeta;  // dummy to suppress unused var warning
            if (jacobian__)
                zeta = in__.vector_constrain(K, lp__);
            else
                zeta = in__.vector_constrain(K);
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> mub(J);
            stan::math::initialize(mub, DUMMY_VAR__);
            stan::math::fill(mub, DUMMY_VAR__);
            stan::math::assign(mub,add(add(alpha, multiply(building_data, zeta)), multiply(mub_sigma, Z)));
            ...
            for (size_t j_1__ = 0; j_1__ < mub_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(mub(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: mub" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable mub: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 40;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "hier_NB_regression_ncp_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> Z = in__.vector_constrain(J);
        size_t Z_j_1_max__ = J;
        for (size_t j_1__ = 0; j_1__ < Z_j_1_max__; ++j_1__) {
            vars__.push_back(Z(j_1__));
        }

        Eigen::Matrix<double, Eigen::Dynamic, 1> zeta = in__.vector_constrain(K);
        size_t zeta_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < zeta_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "hier_NB_regression_ncp_model";
    }
...
typedef hier_NB_regression_ncp_model_namespace::hier_NB_regression_ncp_model stan_model;
